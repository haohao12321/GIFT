...
class GIFT_P(nn.Module):
    ...
    def __init__(self, model_cfg: Dict,num_classes: int = 1000):
        ...
        self.linear1 = nn.Linear(640, 1280)
    ...
    def forward(self, a: Tensor, v: Tensor) -> Tensor:
        #route 1
        a = self.conv_1_a(a)
        a = self.layer_1_a(a)
        a = self.layer_2_a(a)
...
def GIFT_P_(num_classes: int = 1000):
    config = get_config("small")
    m = GIFT_P(config, num_classes=num_classes)
    return m
